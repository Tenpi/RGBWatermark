    ...
    return (
        <div className="bitcrush-image-component">
            ...
            <div className="bitcrush-options-container">
                <div className="bitcrush-row">
                    <span className="bitcrush-text-mini" style={{width: "auto", fontSize: "17px"}}>Downsample?</span>
                    <img className="bitcrush-checkbox" src={downsample ? checkboxChecked : checkbox} onClick={() => updateDownsample()} style={{marginLeft: "5px"}}/>
                </div>
                <div className="bitcrush-row">
